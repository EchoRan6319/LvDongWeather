...
### v4.0.0
- **应用升级**：版本号升级至 4.0.0
- **ColorOS动态取色绕过**：直接通过原生方法获取壁纸颜色，绕过ColorOS系统限制
- **设置页面优化**：移除主题颜色右侧的颜色预览，界面更加简洁
- **详细信息布局**：调整风向和风速等级显示方式，使其更加简洁明了
- **版本更新**：正式发布4.0.0版本

### v3.7.0
- **应用升级**：版本号升级至 3.7.0
- **动态颜色优化**：（可能）修复了Windows上动态壁纸取色不更新的问题
- **跨平台兼容**：所有平台都（可能）正确响应壁纸变化
- **用户体验**：应用从后台返回前台时自动更新动态颜色

### v3.6.0
- **应用升级**：版本号升级至 3.6.0
- **字体移除**：移除OPPO Sans字体及其相关功能，不再内置字体文件
- **代码清理**：清理与字体相关的配置和代码，简化应用结构
